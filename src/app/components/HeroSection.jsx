      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-800 via-blue-500 to-blue-300 hover:bg-slate-200 text-white"
            >
              Contact me
            </Link>
            <Link
